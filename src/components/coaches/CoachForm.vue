<template>
  <form @submit.prevent="submitForm">
    ...
    <!--
    <input-validation fieldName="firstName" label="Firstname" 
      :payload="firstName" errorMessage="Firstname must not be empty.">
    </input-validation> -->
...
<script>
// import InputValidation from '../ui/InputValidation.vue';
