...
export default {
    ...
    tryAutoLogin(context) {
        ...
        // the timer is expiring, so not do autologin
        if(expiresIn < 0) {
            return;
        }
    ...
    async auth(context, payload) {
        ...
        //const expiresIn = 5000; // just for test auto logout
        ...
        /* 
        set timeout if user won't leave the page anymore. 
        If the user remain in the page without refresh and the timer go to zero, logout.
        */
        timer = setTimeout(function() {
            context.dispatch('autoLogout');
        }, expiresIn);
